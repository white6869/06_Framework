...
public class AjaxController {
	...
	// -> forward / redirect를 원하는게 아님!
	// -> "전체 Todo 개수"라는 데이터를 비동기 요청 보낸 클라이언트(브라우저) 반환되는것을 원함.
	// -> 반환되어야하는 결과값의 자료형을 반환형을 써야함!
	@ResponseBody // 반환값을 HTTP 응답 본문으로 직접 정송 (값 그대로 돌려보냄)
>>>>>>> dfbb5ac645c6f5720e59286ec726d937ebb005e5
...
=======
	...
	@PostMapping("add")
	public int addTodo(@RequestBody Todo todo) {
		 // 요청body(본문)d에 담긴값을 Todo라는 DTO에 저장.
>>>>>>> dfbb5ac645c6f5720e59286ec726d937ebb005e5
...
=======
		// -> HttpMssageConverter가 JOSN 형태로 변환하여 반환
	}
>>>>>>> dfbb5ac645c6f5720e59286ec726d937ebb005e5
}
